...
export function SettingsPage() {
  ...
  return <div className="page settings-page"><PageHeader eyebrow="Sistema" title="Configuración" description="Tus datos, tus decisiones." onCapture={capture} />
    ...
    <section className="settings-intro"><ShieldCheck /><div><h2>FARO es local primero.</h2><p>Tus registros permanecen en este navegador. Crea respaldos con frecuencia si vas a usarlo diariamente.</p></div></section>
