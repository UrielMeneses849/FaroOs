...
export function CalendarPage() {
  ...
  return <div className="page calendar-page"><PageHeader eyebrow={data.timezone} title="Calendario" description="Tiempo, contexto y ejecución en una sola vista." onCapture={capture} />
    ...
    {creatingAt && <TaskFormDialog open dueAt={creatingAt} estimatedMinutes={creatingDuration} workspaceId={creatingWorkspace} onClose={() => { setCreatingAt(undefined); setCreatingDuration(undefined); setCreatingWorkspace(undefined); queueMicrotask(refreshFromStore) }} />}
